...
map("n", "<leader>TT", function() require("util.terminal").float_term() end, { desc = "Toggle terminal" })
-- lazygit
if vim.fn.executable("lazygit") == 1 then
map("n", "<leader>gg", function() require("utils").float_term({ "lazygit" }, { cwd = require("util").root(), esc_esc = false }) end, { desc = "Lazygit (root dir)" })
